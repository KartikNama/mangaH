...
var define_IMAGES_LOCAL_PATTERNS_default = [{ pathname: "^(?:\\/media(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)|$))$" }, { pathname: "^(?:\\/_next\\/static\\/media(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)|$))$", search: "" }];

// <define:__IMAGES_QUALITIES__>
var define_IMAGES_QUALITIES_default = [75];

// <define:__IMAGES_REMOTE_PATTERNS__>
var define_IMAGES_REMOTE_PATTERNS_default = [{ protocol: "https", hostname: "^(?:^(?:media\\.saudult\\.xyz)$)$", pathname: "^(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?))$" }];
